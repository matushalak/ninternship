...
from src.utils import group_condition_key, default_neuron_index, default_session_index, load_audvis_files, trialMAPS
...
if __name__ == '__main__':
    ...
    if args.files.lower() in ('y', 'yes', 'true', 't'):
        ...
        # multiprocessing on 4 cores (4 groups) (joblib would probably be better)
